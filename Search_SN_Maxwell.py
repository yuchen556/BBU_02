...
class fetch_MAC:
    ...
    def search_db_sn(self):
        ...
        query0 = "SELECT * FROM machistory WHERE mac_status = '{0:s}'".format(self.SN)
        # query01: search the free in the mac_spinel table or not
        internal_free = "free"
        query01 = "SELECT * FROM macinfo WHERE mac_status = '{0:s}'".format(internal_free)
        print(self.SN)
        print(type(self.SN))
        ...
        try:
            ...
            with open(self.logname, 'a+') as f:
                f.write("Check mac history result is: %s \r" % result_query0_all)
            ...
            if mycursor.rowcount == 0:
                ...
                for sn_x0 in result_query01_7:
                    # print("test111")
                    query_insert = "INSERT INTO machistory (mac_address, mac_status, project_name) VALUES ('{0:s}', '{1:s}', 'bbu')".format(sn_x0[1], self.SN)
                    # print(query_insert)
